...
- The 23 baseline probes are deterministic contract checks over fixtures and
...
- Holly configuration files are packaged for installation, and routing,
  retention, safety, and audit behavior are now config-driven, but only within
