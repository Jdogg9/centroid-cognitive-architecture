...
Model output is treated as untrusted input. Provider tool calls are normalized as proposals and routed through Centroid safety policy; no provider tool proposal executes regardless of disposition.
